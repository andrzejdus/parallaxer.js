...
(function(a,b){a.Parallaxer=new function(){var a=!1,b,e=new andrzejdus.parallaxer.ParallaxerCore;this.init=function(){e.setSmoothScrollEnabled(a);b=[];$('[data-parallaxer="enabled"]').each(function(){var a=$(this);b.push({element:this,$element:a,initialElementOffsetTop:a.offset().top,offsetTop:parseInt(a.data("parallaxer-offset-top"),10)||0,speed:a.data("parallaxer-speed"),orientation:a.data("parallaxer-orientation"),autoCss:"false"!==a.attr("data-parallaxer-auto-css")})});for(var g=0;g<b.length;g++){var f=
b[g];f.autoCss&&f.$element.css({position:"fixed",top:"0px"});e.addElement(f.element,f.speed,f.initialElementOffsetTop,andrzejdus.parallaxer.ParallaxerCore.VERTICAL)}var h=$(window);h.on("scroll.andrzejdus-parallaxer",function(){var a=h.scrollTop();e.setTargetScrollPosition(a)});e.refresh()};this.stop=function(){$(window).off("scroll.andrzejdus-parallaxer");for(var a=Modernizr.prefixed("transform"),c=0;c<b.length;c++){var e=b[c];e.autoCss&&(e.$element.css({position:"",top:""}),e.element.style[a]="")}};
this.setSmoothScrollEnabled=function(b){a=b};this.getCore=function(){return e}}})(andrzejdus.parallaxer);goog.exportSymbol("andrzejdus.parallaxer.Parallaxer",andrzejdus.parallaxer.Parallaxer);
